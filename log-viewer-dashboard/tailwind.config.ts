...
const config: Config = {
  ...
  safelist: [
    // Log level colors - ensure these classes are not purged
    'bg-red-50', 'bg-red-100', 'bg-red-900', 'bg-red-950',
    'bg-yellow-50', 'bg-yellow-100', 'bg-yellow-900', 'bg-yellow-950',
    'bg-blue-50', 'bg-blue-100', 'bg-blue-900', 'bg-blue-950',
    'bg-gray-50', 'bg-gray-100', 'bg-gray-800', 'bg-gray-950',
    ...
    'border-l-red-500', 'border-l-yellow-500', 'border-l-blue-500', 'border-l-gray-500',
  ],
  theme: {
  	extend: {
  		colors: {
